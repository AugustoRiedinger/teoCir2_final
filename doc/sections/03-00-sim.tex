\section{Simulaciones y experimentos}
    ...
    Queda definida entonces la FT $H_{FIR}^{+}(z)$, y se puede insertar en GNU Octave con el algoritmo que se muestra en el algoritmo a continuación. En la Fig. \ref{fig:03-00-hfir+} se puede observar la respuesta al impulso de la misma.

    \lstinputlisting[language=Octave]{../code/tiir.m}
